          ...
          <a-col :offset="index === 0 ? 0 : 4" :span="18">
            <a-row :gutter="5" class="model-input-row">
              ...
              <a-col :span="8">
                <a-form-item 
                  label="Table"
                  :name="['config', 'input', index, 'Table']"
                  :rules="{ required: true, message: '请填写', trigger: 'change' }">
                  <a-input v-model:value="input.Table"></a-input>
                </a-form-item>
              </a-col>
              <a-col :span="8">
                <a-form-item 
                  label="Tag" 
                  :name="['config', 'input', index, 'Tag']"
                  :rules="{ required: true, message: '请填写', trigger: 'change' }">
                  <a-input v-model:value="input.Tag"></a-input>
                </a-form-item>
              </a-col>
              <MinusCircleOutlined
          ...
          <a-col :offset="index === 0 ? 0 : 4" :span="18">
            <a-row :gutter="5" class="model-input-row">
              ...
              <a-col :span="8">
                <a-form-item 
                  label="Table"
                  :name="['config', 'output', index, 'Table']"
                  :rules="{ required: true, message: '请填写', trigger: 'change' }">
                  <a-input v-model:value="output.Table"></a-input>
                </a-form-item>
              </a-col>
              <a-col :span="8">
                <a-form-item 
                  label="Tag" 
                  :name="['config', 'output', index, 'Tag']"
                  :rules="{ required: true, message: '请填写', trigger: 'change' }">
                  <a-input v-model:value="output.Tag"></a-input>
                </a-form-item>
              </a-col>
              <MinusCircleOutlined
                class="dynamic-delete-button"
