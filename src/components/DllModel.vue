<template>
  <a-form
    ...
    >
      ...
      <a-form-item label="namespace" name="namespace">
        <a-input v-model:value="formState.namespace"></a-input>
      </a-form-item>
      <a-form-item label="classname" name="classname">
        <a-input v-model:value="formState.classname"></a-input>
      </a-form-item>
      <a-form-item label="classargs" name="classargs">
        <a-input v-model:value="formState.classargs"></a-input>
      </a-form-item>
      <a-form-item label="methodname" name="methodname">
        <a-input v-model:value="formState.methodname"></a-input>
      </a-form-item>
      <a-form-item label="dependency" name="dependency">
        <a-input v-model:value="formState.dependency"></a-input>
      </a-form-item>
          ...
          <a-col :offset="index === 0 ? 0 : 4" :span="18">
            <a-row :gutter="5" class="model-input-row">
              ...
              <a-col :span="12">
                <a-form-item 
                  label="Unit" 
                  :name="['config', 'input', index, 'Unit']"
                  :rules="{ required: true, message: '请填写', trigger: 'change' }">
                  <a-input v-model:value="input.Unit"></a-input>
                </a-form-item>
              </a-col>
              <MinusCircleOutlined
          ...
          <a-col :offset="index === 0 ? 0 : 4" :span="18">
            <a-row :gutter="5" class="model-input-row">
              ...
              <a-col :span="12">
                <a-form-item 
                  label="Unit" 
                  :name="['config', 'output', index, 'Unit']"
                  :rules="{ required: true, message: '请填写', trigger: 'change' }">
                  <a-input v-model:value="output.Unit"></a-input>
                </a-form-item>
              </a-col>
              <MinusCircleOutlined
                class="dynamic-delete-button"
  ...
  methods: {
    setFormState() {
      if(this.modelInfo) {
        ...
        this.formState.namespace = this.modelInfo.namespace
        this.formState.classname = this.modelInfo.classname
        this.formState.classargs = this.modelInfo.classargs
        this.formState.methodname = this.modelInfo.methodname
        this.formState.dependency = this.modelInfo.dependency
